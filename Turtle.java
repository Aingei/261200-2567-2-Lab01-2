...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        bob.penColor(new Color(150, 149, 89));
        ...
        for(int k = 0; k< 4;k++) {
            bob.penColor("Red");
                for (int j = 0; j < 5; j++) {
                    ...
                    bob.right(72); // Angle between petals
                }
                bob.left(180);
                bob.forward(200);
                //krathong
        ...
        //stars
        bob.penColor(new Color(233, 226, 38));
            bob.up();
            bob.forward(1500);
            for (int j = 0; j < 5; j++) { // Loop for multiple stars
            // Draw a star
                for (int i = 0; i < 5; i++) {
                bob.forward(150); // Length of each arm of the star
                bob.right(144);   // Angle between the points of the star
            }
        ...
        bob.down();
        //water
        bob.penColor("Blue"); // Change pen color to blue for the river

        for (int i = 0; i < 12; i++) { // Create wavy lines for the river
            for (int j = 0; j < 36; j++) { // Draw one wave
                bob.forward(5);
                bob.left(5);
            }
            for (int j = 0; j < 36; j++) { // Draw the other side of the wave
                bob.forward(5);
                bob.right(5);
            }
        }
        ...
        /* quiz bob.penColor("blue");
        bob.width(5);
        bob.speed(200);
        bob.forward(150);    // move 30 units (pen down = draw a line)
        bob.left(90);
        bob.forward(90);
        bob.left(90);
        bob.forward(150);
        ...
        for (int j = 0; j < 5; j++) { // Loop for multiple stars
            ...
            bob.up();             // Lift the pen to stop drawing
            bob.forward(100);     // Move forward to a new spot
            bob.right(72);        // Rotate slightly for variety
            bob.down();           // Put the pen down to draw again
        }
